...
export class DropdownIconsCategory extends Component {
    state = {
        iconValue: ''
    }
    render() {
                ...
                <Row >
                    <Col style={{ paddingLeft: 0, paddingRight: 0 }} >
                        ...
                        <Select
                            ...
                            onChange={(value) => { this.props.iconValue(value); this.setState({ iconValue: value }) }}
...
export default DropdownIconsCategory
